...
docker exec z8_dev_mariadb mysql "-u$database_user" "-p$database_password" "-h$database_host" "-P$database_port" \
...
docker cp structure.sql z8_dev_mariadb:/structure.sql
docker exec z8_dev_mariadb mysql "-u$database_user" "-p$database_password" "$database_name" "-h$database_host" "-P$database_port" \
